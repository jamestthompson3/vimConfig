...
_G.packer_plugins = {
  ...
  ["lush.nvim"] = {
    loaded = true,
    path = "/home/taylor/.local/share/nvim/site/pack/packer/start/lush.nvim"
  },
  ["nvim-cmp"] = {
  ...
  ["nvim-dap"] = {
    config = { "\27LJ\2\n­\4\0\0\a\0\19\0$6\0\0\0'\2\1\0B\0\2\0029\1\2\0005\2\4\0004\3\3\0006\4\5\0009\4\6\4'\6\a\0B\4\2\2'\5\b\0&\4\5\4>\4\1\3=\3\t\2=\2\3\0019\1\n\0004\2\3\0005\3\f\0006\4\r\0009\4\14\0049\4\15\4B\4\1\2=\4\16\3>\3\1\2=\2\v\0019\1\n\0004\2\3\0005\3\18\0006\4\r\0009\4\14\0049\4\15\4B\4\1\2=\4\16\3>\3\1\2=\2\17\1K\0\1\0\1\0\6\fprogram\f${file}\rprotocol\14inspector\15sourceMaps\2\frequest\vlaunch\fconsole\23integratedTerminal\ttype\nnode2\15typescript\bcwd\vgetcwd\afn\bvim\1\0\6\fprogram\f${file}\rprotocol\14inspector\15sourceMaps\2\frequest\vlaunch\fconsole\23integratedTerminal\ttype\nnode2\15javascript\19configurations\targsF/.config/nvim/langservers/vscode-node-debug2/out/src/nodeDebug.js\tHOME\vgetenv\aos\1\0\2\ttype\15executable\fcommand\tnode\nnode2\radapters\bdap\frequire\0" },
    loaded = false,
    needs_bufread = false,
  ...
  ["nvim-lspconfig"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/home/taylor/.local/share/nvim/site/pack/packer/opt/nvim-lspconfig"
  },
  ["nvim-treesitter"] = {
  ...
  ["nvim-web-nonicons"] = {
    loaded = true,
    path = "/home/taylor/.local/share/nvim/site/pack/packer/start/nvim-web-nonicons"
  },
  ["packer.nvim"] = {
    loaded = false,
    needs_bufread = false,
    path = "/home/taylor/.local/share/nvim/site/pack/packer/opt/packer.nvim"
  },
  ["pear-tree"] = {
    loaded = true,
    path = "/home/taylor/.local/share/nvim/site/pack/packer/start/pear-tree"
  },
  ["plenary.nvim"] = {
    loaded = true,
  ...
  tagbar = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/home/taylor/.local/share/nvim/site/pack/packer/opt/tagbar"
  },
  ...
  ["telescope-fzy-native.nvim"] = {
    loaded = true,
    path = "/home/taylor/.local/share/nvim/site/pack/packer/start/telescope-fzy-native.nvim"
  },
  ["telescope.nvim"] = {
  ...
  ["vim-apathy"] = {
    loaded = true,
    path = "/home/taylor/.local/share/nvim/site/pack/packer/start/vim-apathy"
  },
  ["vim-commentary"] = {
    loaded = true,
  ...
  ["vim-cool"] = {
    loaded = true,
    path = "/home/taylor/.local/share/nvim/site/pack/packer/start/vim-cool"
  },
  ["vim-dirvish"] = {
    loaded = true,
    path = "/home/taylor/.local/share/nvim/site/pack/packer/start/vim-dirvish"
  },
  ["vim-gutentags"] = {
    loaded = true,
    path = "/home/taylor/.local/share/nvim/site/pack/packer/start/vim-gutentags"
  },
  ["vim-matchup"] = {
    loaded = true,
    path = "/home/taylor/.local/share/nvim/site/pack/packer/start/vim-matchup"
  },
  ["vim-repeat"] = {
    loaded = true,
  ...
  ["vim-wordy"] = {
    loaded = false,
    needs_bufread = false,
    path = "/home/taylor/.local/share/nvim/site/pack/packer/opt/vim-wordy"
  }
}
...
vim.cmd [[au FileType javascript ++once lua require("packer.load")({'tagbar', 'nvim-dap', 'nvim-lspconfig'}, { ft = "javascript" }, _G.packer_plugins)]]
...
vim.cmd [[au FileType typescript ++once lua require("packer.load")({'tagbar', 'nvim-dap', 'nvim-lspconfig'}, { ft = "typescript" }, _G.packer_plugins)]]
vim.cmd("augroup END")
END
