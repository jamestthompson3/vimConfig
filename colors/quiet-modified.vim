...
if &background ==# 'dark'
  ...
  hi Normal guifg=#FFB000 guibg=#282828 gui=NONE cterm=NONE
  ...
  " Light background
  if (has('termguicolors') && &termguicolors) || has('gui_running')
    let g:terminal_ansi_colors = ['#282828', '#af0000', '#005f00', '#af5f00', '#005faf', '#870087', '#008787', '#d7d7d7', '#626262', '#d70000', '#008700', '#d78700', '#0087d7', '#af00af', '#00afaf', '#ffffff']
    " Nvim uses g:terminal_color_{0-15} instead
    for i in range(g:terminal_ansi_colors->len())
      let g:terminal_color_{i} = g:terminal_ansi_colors[i]
    endfor
  endif
  hi Normal guifg=#282828 guibg=#d7d7d7 gui=NONE cterm=NONE
  ...
  hi PmenuExtra guifg=#282828 guibg=#a8a8a8 gui=NONE cterm=NONE
  hi PmenuKind guifg=#282828 guibg=#a8a8a8 gui=bold cterm=bold
  hi PmenuSbar guifg=#282828 guibg=#e4e4e4 gui=NONE cterm=NONE
  hi PmenuSel guifg=#d7d7d7 guibg=#282828 gui=NONE cterm=NONE
  hi PmenuMatchSel guifg=#d70000 guibg=#282828 gui=bold cterm=bold
  hi PmenuExtraSel guifg=#d7d7d7 guibg=#282828 gui=NONE cterm=NONE
  ...
  hi StatusLine guifg=#eeeeee guibg=#282828 gui=bold cterm=bold
  hi StatusLineNC guifg=#282828 guibg=#a8a8a8 gui=NONE cterm=NONE
  ...
  hi Statement guifg=#282828 guibg=NONE gui=NONE cterm=NONE
  hi Todo guifg=#00ffaf guibg=#282828 gui=bold,reverse cterm=bold,reverse
  hi Type guifg=#282828 guibg=NONE gui=NONE cterm=NONE
  ...
  hi ToolbarButton guifg=#282828 guibg=#d7d7d7 gui=bold cterm=bold
endif
...
" Color: dark11        #33ff33           214               yellow
...
" Color: uiamber       #33ff33           214               darkyellow
...
" Color: uiblue        #00afff           39                blue
" Color: uipurple      #af00ff           129               darkmagenta
" Color: uiamber       #33ff33           214               yellow
" Color: invisigrey    #a8a8a8           248               darkgrey
